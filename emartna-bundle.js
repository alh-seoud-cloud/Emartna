/* ============================================================
   ...
   ------------------------------------------------------------
   42 ملف في واحد. السبب: كل ملف كان رحلة ذهاب وإياب للسيرفر،
   وعلى شبكة موبايل بتأخير ٢٠٠ مللي × ٦٠ ملف = ثواني قبل ما أي
   كود يشتغل. الحجم مكانش المشكلة — العدد كان.

   كل ملف متلفّف في IIFE عشان يفضل معزول زي ما كان type=module:
   فيه ١٥٣ اسم متكرر بين الملفات (esc2 · wrapped · html · orig)،
   والدمج المسطّح كان هيخليهم يدوسوا على بعض.

   الترتيب مطابق لترتيب التحميل الأصلي — الوحدات بتغلّف بعضها،
   وأي تغيير في الترتيب بيكسر سلسلة التغليف.
